...
# %% Move  Spheromak source
    ...
    def moving_sphmk_source(self, R, a, alpha, psi0, t, problem):
        logger.log_n_output_colored_message(
            ...
            color='green',
            white_message="disp_fact*vessl_rad*t/tm = %s*%s*%.3e/%.3e" % (str(problem.disp_fact), str(problem.plasma_step_length), t, problem.tm))
    ...
    def moving_point_source(self, R, a, t, problem):
        ...
        sigma = problem.plasma_step_length#M.a/0.13*0.04
